...
const items: RoadmapItem[] = [
  ...
  },
  {
    ...
    description: "День за днём считается движком (src/lib/capstoneSim.ts): спрос генерируется каждый день, пополнение триггерится реальной reorder-point формулой, стоимость — тем же cargo-калькулятором, что и в Модуле 21. Сравнение с эталонной (не обязательно оптимальной) стратегией на том же месяце. Упрощение: 3 показательных SKU вместо всех 24.",
    status: "done",
  },
  {
